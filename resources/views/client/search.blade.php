                   ...
                   <div class="doctor-widget">
                      <div class="doc-info-left">
                         ...
                         <div class="doc-info-cont">
                            <h4 class="doc-name"><a href="doctor-profile.html">Dr. Ruby Perrin <i class="feather-check-circle verified ml-2"></i></a></h4>
                      ...
                      <div class="doc-info-right">
                         ...
                         <div class="clinic-booking">
                            ...
                            <a class="apt-btn" href="booking.html">Book Now</a>
                         </div>
                      </div>
                   </div>
                </div>
                ...
                <div class="card-body">
                   <div class="doctor-widget">
                      <div class="doc-info-left">
                         ...
                         <div class="doc-info-cont">
                            <h4 class="doc-name"><a href="doctor-profile.html">Dr. Darren Elder <i class="feather-check-circle verified ml-2"></i></a></h4>
                      ...
                      <div class="doc-info-right">
                         <div class="clini-infos">
                            <ul>
                               <li><i class="feather-calendar"></i> Available on Fri, 20 Mar</li>
                               <li><i class="feather-map-pin"></i> Newyork, USA</li>
                               <li><i class="far fa-money-bill-alt"></i> $50 - $300 <i class="feather-info" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
                            </ul>
                         </div>
                         <div class="clinic-booking">
                            <a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
                ...
                <div class="card-body">
                   <div class="doctor-widget">
                      <div class="doc-info-left">
                         ...
                         <div class="doc-info-cont">
                            <h4 class="doc-name"><a href="doctor-profile.html">Dr. Deborah Angel <i class="feather-check-circle verified ml-2"></i></a></h4>
                      ...
                      <div class="doc-info-right">
                         <div class="clini-infos">
                            <ul>
                               <li><i class="feather-calendar"></i> Available on Fri, 20 Mar</li>
                               <li><i class="feather-map-pin"></i> Newyork, USA</li>
                               <li><i class="far fa-money-bill-alt"></i> $100 - $400 <i class="feather-info" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
                            </ul>
                         </div>
                         <div class="clinic-booking">
                            <a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
                ...
                <div class="card-body">
                   <div class="doctor-widget">
                      <div class="doc-info-left">
                         ...
                         <div class="doc-info-cont">
                            <h4 class="doc-name"><a href="doctor-profile.html">Dr. Sofia Brient <i class="feather-check-circle verified ml-2"></i></a></h4>
                      ...
                      <div class="doc-info-right">
                         <div class="clini-infos">
                            <ul>
                               <li><i class="feather-calendar"></i> Available on Fri, 20 Mar</li>
                               <li><i class="feather-map-pin"></i> Newyork, USA</li>
                               <li><i class="far fa-money-bill-alt"></i> $150 - $250 <i class="feather-info" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
                            </ul>
                         </div>
                         <div class="clinic-booking">
                            <a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
                ...
                <div class="card-body">
                   <div class="doctor-widget">
                      <div class="doc-info-left">
                         ...
                         <div class="doc-info-cont">
                            <h4 class="doc-name"><a href="doctor-profile.html">Dr. Katharine Berthold <i class="feather-check-circle verified ml-2"></i></a></h4>
                      ...
                      <div class="doc-info-right">
                         <div class="clini-infos">
                            <ul>
                               <li><i class="feather-calendar"></i> Available on Fri, 20 Mar</li>
                               <li><i class="feather-map-pin"></i> Texas, USA</li>
                               <li><i class="far fa-money-bill-alt"></i> $100 - $500 <i class="feather-info" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
                            </ul>
                         </div>
                         <div class="clinic-booking">
                            <a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
